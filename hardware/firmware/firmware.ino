...
// FIXED: Proper handler function for /data endpoint
void handleData() {
  server.sendHeader("Access-Control-Allow-Origin", "*");
...
void loop() {
  ...
  // FIXED: Proper JSON string formatting with escaped quotes
  data = "{";
  data += "\"temperature\":" + String(temperature) + ",";
  data += "\"humidity\":" + String(humidity) + ",";
  data += "\"soil_moisture\":" + String(soilMoistureValue) + ",";
  data += "\"reed_switch_state\":" + String(reedSwitchState) + ",";
  data += "\"relay1_state\":" + String(relay1State) + ",";
  data += "\"relay2_state\":" + String(relay2State);
  data += "}";
